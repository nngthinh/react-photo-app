...
describe("name", () => {
  it("is valid", () => {
    expect(validateName("1")).toBe(null);
    expect(validateName("1234567890123456")).toBe(null);
    expect(validateName("123456789012345678901234567890")).toBe(null);
  });
  it("is not valid", () => {
    expect(validateName("")).toBe("Length must be between 1 and 30.");
    expect(validateName("1234567890123456789012345678901")).toBe(
