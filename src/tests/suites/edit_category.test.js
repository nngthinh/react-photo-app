...
describe("edit category", () => {
  ...
  it("navigate to sign in page for guest", async () => {
    render(<App />, { route: "/categories/1/edit" });
  ...
  it("should return no error", async () => {
    ...
    userEvent.click(screen.getByTestId("editCategoryButton"));
    ...
    await screen.findByText(/Update category successfully./i);
  });
